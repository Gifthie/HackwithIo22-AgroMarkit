    ...
    <div class="mx-auto">
      <div>
        <Popover class="top-0 sticky z-10 bg-white shadow-sm">
          <div class="py-6 border-b border-orange-50 px-4 sm:px-6 lg:px-8">
            <nav class="flex items-center justify-between sm:h-10" aria-label="Global">
              ...
              <div class="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
                ...
                <a href="https://forms.gle/THUBKiaoQuWwFHfc6" class="font-medium text-gray-500 hover:text-gray-900" target="_blank">Register</a>
              </div>
            </nav>
          </div>
            ...
            <PopoverPanel focus class="absolute z-10 top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
              <div class="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                ...
                <div class="px-2 pt-2 pb-3 space-y-1">
                  ...
                  <a href="https://forms.gle/THUBKiaoQuWwFHfc6" class="block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50">Register</a>
                </div>
              </div>
            </PopoverPanel>
          </transition>
        ...
        <footer class="p-4 bg-white rounded-lg shadow md:px-6 md:py-8 dark:bg-gray-800">
          <div class="flex items-center justify-center sm:mb-8 my-3">
              <a href="/" class="flex items-center mb-0">
                  <img src="../assets/logo.png" class="mr-3 h-8" alt="Parakletus Logo" />
                  <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">AgroMarkit</span>
              </a>
          </div>


          <span class="block text-sm text-gray-500 text-center dark:text-gray-400 mt-4">© 2022 <a href="/" class="hover:underline">AgroMarkit</a>. All Rights Reserved.
          </span>
        </footer>
      </div>
    </div>
